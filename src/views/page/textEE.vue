<template>
  <div>
    ...
    <el-input
      type="textarea"
      placeholder="请输入你想要抽取的句子。/Please input your sentences."
      v-model="textarea"
      maxlength="512"
      show-word-limit
    >
    ...
    <el-button type="primary" :loading="isExtractStatus" @click="startExtract"
      >开始抽取</el-button
    >
